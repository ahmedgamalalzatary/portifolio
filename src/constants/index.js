...
export const myProjects = [
  {
    ...
    title: "Task-Flow",
    description:
      "A comprehensive educational management platform designed for universities and colleges to streamline student, course, and section administration for over 10,000+ potential users.",
    subDescription: [
      "Developed an all-in-one management system that increased administrative efficiency by 40% through automated enrollment and scheduling.",
      "Implemented high-performance features for managing 500+ daily sections and academic records with 99.9% data accuracy.",
